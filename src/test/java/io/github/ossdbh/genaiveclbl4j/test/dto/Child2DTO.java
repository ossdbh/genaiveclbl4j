...
@AllArgsConstructor
@ToString
@GenAIInstance(label = "This is a nested child dto record another @level1 instance begins ")
public class Child2DTO {
    @GenAILabel(label = "This is a nested string @level1 ")
    private String child2DTOStr1;

    @GenAILabel(label = "This is also a nested string another @level1 exiting ")
