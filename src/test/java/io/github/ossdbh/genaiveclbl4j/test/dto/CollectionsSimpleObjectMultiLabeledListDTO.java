...
public class CollectionsSimpleObjectMultiLabeledListDTO {
    ...
    @GenAILabel(label = "This is a list element first label ")
    @GenAILabel(label = "This is a list element second label ")
